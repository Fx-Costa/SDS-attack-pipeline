...
class Evaluator:
    ...
    def _load_sensitive_aggregates(self):
        logging.debug('Loading sensitive aggregates...')
    ...
    def _load_reportable_aggregates(self):
        logging.debug('Loading reportable aggregates...')
    ...
    def _load_synthetic_aggregates(self):
        logging.debug('Computing synthetic aggregates...')
    ...
    def _do_records_analysis(self):
        logging.debug('Performing records analysis on sensitive aggregates...')
    ...
    def _write_parameters(self):
        logging.debug('Writing evaluation parameters...')
    ...
    def _calculate_preservation_by_count(self):
        logging.debug('Calculating preservation by count...')
    ...
    def _calculate_preservation_by_length(self):
        logging.debug('Calculating preservation by length...')
    ...
    def _calculate_synthetic_data_stats(self):
        logging.debug('Calculating synthetic data stats...')
    ...
    def _calculate_aggregate_counts_stats(self):
        logging.debug('Calculating aggregate counts stats...')
        summary = self._gen_stats_summary(
